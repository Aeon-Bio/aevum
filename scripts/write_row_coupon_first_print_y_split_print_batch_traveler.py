...
def _default_output_path() -> Path:
    ...
    return (
        ...
        / "data"
        / "measurements"
        / f"{today}_one_row_coupon_y_split_print_batch_traveler.csv"
    )
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Split print batch traveler CSV path to create.",
    )
    parser.add_argument(
        "--record",
    ...
    output = write_first_print_y_split_print_batch_traveler(
        params=params,
