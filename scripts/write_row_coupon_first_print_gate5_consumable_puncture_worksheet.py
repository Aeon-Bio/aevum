...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Gate 5 consumable/puncture worksheet CSV path to create.",
    )
    parser.add_argument(
        "--overwrite",
        action="store_true",
        help="Replace an existing Gate 5 consumable/puncture worksheet.",
    )
    args = parser.parse_args()

    params = load_params(args.params)
    output = write_first_print_gate5_consumable_puncture_worksheet(
        params=params,
    ...
    print(f"gate5_consumable_puncture_worksheet: {output}")
