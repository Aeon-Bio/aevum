...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Gate 2 dry assembly worksheet CSV path to create.",
    )
    parser.add_argument(
        "--overwrite",
        action="store_true",
        help="Replace an existing Gate 2 dry assembly worksheet.",
    )
    args = parser.parse_args()

    params = load_params(args.params)
    output = write_first_print_gate2_dry_assembly_worksheet(
        params=params,
    ...
    print(f"gate2_dry_assembly_worksheet: {output}")
